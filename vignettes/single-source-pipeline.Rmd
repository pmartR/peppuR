...
```{r, echo=FALSE, tidy.opts=list(width.cutoff=50)}

knitr::kable(data.frame(output_probabilities)[1:10,], row.names = FALSE, align = 'l')
```
...
#                     nu=1/100, conv_check = 50,max_iter=55,epsilon = 0.01, after_conv_checks =2)
```
